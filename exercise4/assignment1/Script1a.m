...
sigma = 3; thresh = 25000; 
[x1, y1, A1] = hessian_points(A_gray, sigma, thresh);
H1 = insertMarker(A_gray,[x1,y1],'x','color','red','size', 5);

sigma = 6; % thresh = 25000; 
[x2, y2, A2] = hessian_points(A_gray, sigma, thresh);
H2 = insertMarker(A_gray,[x2,y2],'x','color','red','size', 5);

sigma = 9; % thresh = 25000; 
[x3, y3, A3] = hessian_points(A_gray, sigma, thresh);
